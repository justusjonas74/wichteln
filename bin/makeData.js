...
class Game {
    ...
    saveToDisk() {
        ...
        this.players.forEach(player => {
            ...
            invitations += `Liebe(r) ${player.name}, \num zu erfahren, für wen du am Heiligabend der Wichtel bist, gebe auf https://wichteln.francisdoege.com und gib dort deinen persönlichen Code ein: ${player.hashString}\n\n`;
        });
